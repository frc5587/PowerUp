...
public class CenterToRightSwitchFront extends CommandGroup{
    public CenterToRightSwitchFront() {
        addParallel(new ElevatorToSetpoint(HeightLevels.SWITCH));
        addSequential(new GyroCompMPRunner("CenterToRightSwitchFront"), 5);
